...
from indexer import enroll_page, flywheel_page, launch_page, launchlab_page, phases_page, site, splitter_page  # noqa: E402
...
def static_pages(web: Path) -> dict:
    ...
    if launchlab_page.load() is not None:
        pages[launchlab_page.LAUNCHLAB_FILENAME] = launchlab_page.render()
